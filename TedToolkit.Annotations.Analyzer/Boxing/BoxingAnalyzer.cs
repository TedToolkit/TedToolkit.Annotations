...
/// <summary>
/// Reports boxing conversions that are not made explicit through <c>Explicit.Box</c>.
/// </summary>
...
public sealed class BoxingAnalyzer : DiagnosticAnalyzer
{
    ...
    /// </summary>
    public const string DIAGNOSTIC_ID = "TTA201";
    ...
    {
        // Roslyn may insert one or more conversions around the argument before it reaches Explicit.Box.
