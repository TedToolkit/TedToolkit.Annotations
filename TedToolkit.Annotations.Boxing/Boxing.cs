...
{
    /// <summary>Boxes a value as <see cref="object"/>.</summary>
    ...
    /// <summary>Boxes a nullable value or returns <see langword="null"/>.</summary>
    ...
    /// <summary>Boxes a value and exposes it as the requested reference type.</summary>
    ...
    public static TTarget Box<TTarget, TValue>(TValue value)
        where TTarget : class
        where TValue : struct => (TTarget)(object)value;

    /// <summary>Boxes a nullable value and exposes it as the requested reference type.</summary>
    /// <typeparam name="TTarget">The reference type exposed by the boxed value.</typeparam>
